...
import { Card, CardContent, CardHeader, CardTitle } from '../components/Card'; // Import your custom Card
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Feature icon={ScanLine} title="Effortless Receipt Scanning" description="Snap any grocery receipt; get an instant, itemised breakdown." />
            <Feature icon={TrendingUp} title="Personal Inflation Tracking" description="See how your basket's prices evolve over time." />
            <Feature icon={Lightbulb} title="Smart Financial Insights" description="Identify rising costs, better store options, and smarter swaps." />
            <Feature icon={HeartPulse} title="Nutrition Meets Value" description="Link spending patterns with the nutritional quality of your food." />
            <Feature icon={Users} title="Household Sharing" description="Sync spending and insights across your family for complete visibility." />
          </div>
        </motion.div>
