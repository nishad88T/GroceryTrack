          ...
          <Card className="mb-8">
            <CardContent className="p-6 md:p-8 space-y-8">
              ...
              <Section icon={Mail} title="5. Contact">
                <p>
                  For questions, contact <a href__="mailto:support@grocerytrack.co.uk" className="text-emerald-600 hover:underline font-semibold">support@grocerytrack.co.uk</a>.
                </p>
              </Section>
            </CardContent>
          </Card>
